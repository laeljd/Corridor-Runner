    ...
    private static void UpdatePaths()
    {
        ...
        switch (Application.platform)
        {
            case RuntimePlatform.OSXEditor:
				...
				OuyaPanel.FindFile(new DirectoryInfo("/Applications/Unity/PlaybackEngines/AndroidPlayer/Variations/mono/Development/Classes"), OuyaPanel.FILE_UNITY_JAR, ref m_pathUnityJar);
